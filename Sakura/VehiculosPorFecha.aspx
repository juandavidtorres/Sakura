<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPagePrincipal.master" CodeBehind="VehiculosPorFecha.aspx.vb" Inherits="Sakura.VehiculosPorFecha" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h6 class="panel-title"><i class="icon-search2"></i>Vehiculos por fecha</h6>
        </div>
            ...
            <div class="col-sm-6">
             ...
             <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="txtTipoVehiculo" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                </div>
            </div>
