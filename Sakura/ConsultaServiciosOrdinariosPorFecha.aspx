<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPagePrincipal.master" CodeBehind="ConsultaServiciosOrdinariosPorFecha.aspx.vb" Inherits="Sakura.ConsultaServiciosOrdinariosPorFecha" %>
        ...
        <ContentTemplate>
            <asp:MultiView ID="Contenedor" runat="server" ActiveViewIndex="-1">
                ...
                <asp:View runat="server" ID="ViewAsistentes">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h6 class="panel-title"><i class="icon-checkmark3"></i>Edicion del servicio</h6>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Servicio:</label>
                                    <asp:DropDownList ID="TipoServicioActualizar" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                                ...
                                <ContentTemplate>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="ValidadorAsistente" Display="Dynamic" runat="server" Text="" ErrorMessage="*Campo Obligatorio67" CssClass="label label-block label-danger" ControlToValidate="txtCantidadAsistente" ValidationGroup="Asistente" ClientIDMode="Static"></asp:RequiredFieldValidator>
