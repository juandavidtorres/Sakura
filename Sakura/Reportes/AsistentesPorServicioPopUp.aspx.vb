...
Public Class AsistentesPorServicioPopUp
    ...
    Public Sub ConfigurarReporte()
        Try
            ...
            Visor.LocalReport.ReportPath = "Reportes\ReporteAsistentesPorFecha.rdlc"
            ...
            Visor.LocalReport.ReportPath = "Reportes\ReporteAsistentes.rdlc"
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + "ReporteAsistentesPorFecha" + "." + extension)
