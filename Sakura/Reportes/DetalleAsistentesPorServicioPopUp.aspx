<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPagePopUp.master" CodeBehind="DetalleAsistentesPorServicioPopUp.aspx.vb" Inherits="Sakura.DetalleAsistentesPorServicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" 
        ...
        TypeName="Sakura.DataSetAsistenteTableAdapters.RecuperarInformacionServicioPorFechaTableAdapter">
        <SelectParameters>
