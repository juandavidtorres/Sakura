...
Public Class DetalleAsistentesPorServicio
    ...
    Public Sub ConfigurarReporte()
        Try
            ...
            Visor.LocalReport.ReportPath = "Reportes\DatosServiciosPorFecha.rdlc"
            ...
            Dim rds As New ReportDataSource("DataSetDetalle", ObjectDataSource1)
            Visor.LocalReport.ReportPath = "Reportes\DatosServiciosPorFecha.rdlc"
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + "DatosServiciosPorFecha" + "." + extension)
